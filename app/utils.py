...
def create_summary_from_docs(summary_docs, initial_chain, final_sum_list, api_key):
    """
...
def doc_to_final_summary(langchain_document, num_clusters, initial_prompt_list, final_prompt_list, api_key):
    """
    ...
    output = create_summary_from_docs(summary_docs, initial_prompt_list, final_prompt_list, api_key)
    return output
